...
float4 main(PS_IN input) : SV_Target
{
	return input.color; // g_texture.Sample(g_sampler, input.uv) * 
		...
		struct ConstantBuffer
		{
			...
			public const int SizeInBytes = 64; // TODO: Sizeof Matrix4x4
		}
			...
			: base(textureFactory, initialSpriteCapacity)
		{
			...
			this.initialVertexCapacity = initialSpriteCapacity * 4;
		...
		private void PlatformCreateShaders()
		{
			...
			var constantBufferDesc = ResourceDescription.Buffer(ConstantBuffer.SizeInBytes);
